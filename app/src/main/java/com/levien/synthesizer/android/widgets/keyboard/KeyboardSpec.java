...
public class KeyboardSpec {
    ...
    public static KeyboardSpec make2Row() {
        ...
        int width = 12;
        int height = 12;
        ks.addKey(0, 12, width, height, W);   // C
        ks.addKey(6, 0, width, height, B);    // C#
        ks.addKey(12, 12, width, height, W);  // D
        ks.addKey(18, 0, width, height, B);   // D#
        ks.addKey(24, 12, width, height, W);  // E
        ks.addKey(36, 12, width, height, W);  // F
        ks.addKey(42, 0, width, height, B);   // F#
        ks.addKey(48, 12, width, height, W);  // G
        ks.addKey(54, 0, width, height, B);   // G#
        ks.addKey(60, 12, width, height, W);  // A
        ks.addKey(66, 0, width, height, B);   // A#
        ks.addKey(72, 12, width, height, W);  // B
        return ks;
    }
